  ...
  <TheFreeColumsLayout>
    <template #mainSlot>
      <div class="mt-5">
        ...
        <h3>Mittwald</h3>
        <p>
          Anbieter ist die Mittwald CM Service GmbH &amp; Co. KG,
          K&ouml;nigsberger Stra&szlig;e 4-6, 32339 Espelkamp (nachfolgend
          Mittwald).
        </p>
        <p>
          Details entnehmen Sie der Datenschutzerkl&auml;rung von Mittwald:
          <a
            href="https://www.mittwald.de/datenschutz"
            target="_blank"
            rel="noopener noreferrer"
            >https://www.mittwald.de/datenschutz</a
          >.
        </p>
        <p>
          Die Verwendung von Mittwald erfolgt auf Grundlage von Art. 6 Abs. 1
        ...
        <p>
          Klamottenengel e.V<br />
          L&uuml;der-Cl&uuml;ver-Stra&szlig;e 25<br />
          28779 Bremen
        </p>

        <p>
          Telefon: 015222633070<br />
          E-Mail: info@kevin-johr.dev
        </p>
        <p>
